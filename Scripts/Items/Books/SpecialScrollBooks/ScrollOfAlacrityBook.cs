...
namespace Server.Items
{
    ...
    public class ScrollOfAlacrityBook : BaseSpecialScrollBook
    {
        ...
        public static void Initialize()
        {
            ...
            _SkillInfo[SkillCat.Miscellaneous] = new List<SkillName>() { SkillName.ArmsLore, SkillName.Begging, SkillName.Camping, SkillName.TreasureHunting, SkillName.Forensics, SkillName.ItemID, SkillName.TasteID };
            ...
            _SkillInfo[SkillCat.Thievery] = new List<SkillName>() { SkillName.DetectHidden, SkillName.Hiding, SkillName.TreasureHunting, SkillName.Poisoning, SkillName.TreasureHunting, SkillName.Snooping, SkillName.Stealing, SkillName.Hiding };
