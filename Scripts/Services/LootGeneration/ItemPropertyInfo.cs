...
namespace Server.Items
{
    ...
    public class ItemPropertyInfo
    {
        ...
        static ItemPropertyInfo()
        {
            ...
            Register(163, new ItemPropertyInfo(SkillName.Hiding, 1044107, 140, typeof(EnchantedEssence), typeof(StarSapphire), typeof(CrystallineBlackrock), 1, 1, 15, 1112027, new PropInfo(6, 15, 15, new int[] { 20 })));
