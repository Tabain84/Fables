...
namespace Server.Gumps
{
	public class PasswordChanger : Gump
	{
			...
			: base( 0, 0 )
		{
			...
			this.AddLabel( 279, 97, 71, @"Password Changer" );
			this.AddLabel( 160, 130, 151, @"Current Password:" );
			this.AddLabel( 160, 160, 151, @"New Password:" );
			this.AddLabel( 160, 190, 151, @"Confirm New Password:" );
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			switch ( info.ButtonID ) {
				case 0: {
						m.SendMessage( MessageUtil.MessageColorPlayer, "Your password has not changed." );
						return;
					}
				case 1: {
            			...
            			{
							m.SendMessage( MessageUtil.MessageColorError, "The 'Confirm New Password' value does not match the 'New Password'. Remember it is cAsE sEnSaTiVe. " );
						...
						for ( int i = 0; i < newPass.Length; ++i ) {
							...
							{
								m.SendMessage( MessageUtil.MessageColorError, "Passwords may only consist of letters (A - Z) and Digits (0 - 9)." );
								return;
							}
						}
            			...
            			{
							m.SendMessage( MessageUtil.MessageColorError, "The 'Current Password' value is incorrect. [ " + origPass + " ]." );
							m.CloseGump( typeof( PasswordChanger ) );
							m.SendGump( new PasswordChanger() );
							return;
						}
						...
						if ( ( a.CheckPassword( origPass ) ) && ( newPass == confirmNewPass ) ) //Current password is correct, and 2 "New Password" fields match.
            			{
							...
							m.SendMessage( MessageUtil.MessageColorPlayer, "Your account ( " + a.Username + " ) password has been changed to '" + newPass + "'. Remember this!" );
						}
						break;
					}
			}
