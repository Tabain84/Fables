...
namespace Server.Items
{
	...
	{
		private SkillName m_RequiredSkill = SkillName.TreasureHunting; // default skill required to use this augment
		...
		{
			get => m_RequiredSkillLevel;
			set => m_RequiredSkillLevel = value;
		}
		...
		public override bool DestroyAfterUse => UsesRemaining == 0;
		...
		public override bool OnAugment(Mobile from, object target)
		{
			...
			{
				var d = target as LockableContainer;
